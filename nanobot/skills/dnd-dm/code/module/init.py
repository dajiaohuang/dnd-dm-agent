...
from scanner import scan_modules, get_module_level_range, _identify_module
...
def get_chapter_filename(module_name, chapter_label):
    ...
    """
    from scanner import MODULES_DIR
...
def init_module(module_name):
    ...
    try:
        from scene_index import build_scene_index, save_scene_index, set_current_scene
