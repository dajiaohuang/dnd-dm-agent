...
export interface DndRuleSetInfo {
  id: string;
  game_system: string;
  edition: string;
  release: string;
...
export interface DndPublicationInfo {
  id: string;
  name: string;
  slug: string;
  type: string;
...
export interface DndCampaignInfo {
  id: string;
  name: string;
  status: string;
  ...
  save_count: number;
  rule_set: { id: string; game_system: string; edition: string; release: string; locale: string } | null;
  publications: DndPublicationInfo[] | null;
}

export interface DndCharacterInfo {
  id: string;
  name: string;
...
export interface DndFactionInfo {
  score: number;
  attitude: string;
}

export interface DndNpcStatus {
  attitude?: number;
  status?: string;
  trust?: number;
  fear?: number;
...
export interface DndWorldState {
  summary: string;
  factions: Record<string, DndFactionInfo>;
  npcs: Record<string, DndNpcStatus>;
  quests: Record<string, string[]>;
  full_state: Record<string, unknown>;
}

export interface DndSnapshotInfo {
  id: string;
  slot: number;
  label: string;
  campaign_id: string;
...
export interface DndRulesStatus {
  rule_sets: DndRuleSetInfo[];
}

export interface DndCharacterFormData {
  name: string;
  character_type: "pc" | "npc";
  campaign_id?: string;
  player_name?: string;
...
export interface DndRoomCharacter {
  id: string;
  name: string;
  class_name: string;
  level: number;
...
export interface DndRoomInfo {
  campaign_id: string;
  chat_id: string;
  session_key: string;
  characters: DndRoomCharacter[];
}

export interface DndRoomPlayer {
  character_id: string;
  name: string;
}

export interface DndPeerMessage {
  event: "peer_message";
  chat_id: string;
  text: string;
  player: DndRoomPlayer;
  timestamp?: string;
}

export interface DndRoomPresence {
  event: "room_presence";
  chat_id: string;
  players: DndRoomPlayer[];
}
