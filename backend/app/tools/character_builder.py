...
def parse_character_sheet_xlsx(file_path: Path) -> dict | None:
    ...
    # Cells that have label text when unfilled — treat as empty
    _template_labels = {
        "发色", "身高", "肤色", "体重", "瞳色", "背景故事",
        "所选特点", "所选理想", "所选牵绊", "所选缺点",
        "角色外貌", "角色形象", "背景语言", "背景装备",
        "背景特性", "特殊选项", "技能熟练项", "工具熟练项",
        "属性值加成", "职业特性", "种族特性", "名称", "描述",
        "LV", "角色名", "玩家名", "种族", "阵营", "性别", "年龄", "亚种", "信仰", "背景",
        "作者：太易，熊妈妈2D6",  # template credit cell
        "主职业", "兼职", "熟练加值", "属性", "战斗",
        "熟练", "属性值", "调整值", "修正", "豁免",
        "现有值", "最大值", "先攻", "HP", "AC", "生命骰数量",
        "装备盾牌", "生命值成长", "特殊能力数值", "关键属性", "体型", "速度",
        "被动察觉", "抗性/免疫", "技能", "主要装备", "盾牌",
        "熟练", "技能名", "修正", "总值",
        "护甲", "名称", "需要同调", "特性", "重量", "AC", "最大敏捷", "隐匿劣势",
        "盾牌名称", "武器", "攻击加值", "武器伤害", "伤害类型", "弹药数",
        "特殊能力（狂暴、引导神力等）",
        "敏捷系", "智力系", "感知系", "魅力系",
        "左手", "右手", "双手", "其他",
        "角色名", "玩家名",
    ...
    def _val(ws, coord):
        v = _cell(ws, coord)
        return "" if v in _template_labels else v
